...
const VideoTitle = ({title,overview}) => {
  return (
    <div className='pt-[20%] px-6 md:px-24 absolute text-white bg-gradient-to-r from-black w-screen aspect-video opacity-30'>
      ...
      <div className='flex my-2 md:m-0 '>
        ...
        text-lg text-black md:px-8 px-6 rounded-lg hover:bg-opacity-80 py-2'><span className='mr-3 text-xl md:text-6xl'><FaPlay /></span>Play</button>
